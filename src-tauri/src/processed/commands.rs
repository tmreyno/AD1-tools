...
pub fn get_processed_db_summary(
    ...
    let mut summary = ProcessedDbSummary::default();
    summary.total_count = dbs.len();
...
pub fn query_axiom_artifacts_cmd(
    ...
    query_axiom_artifacts(&path, artifact_type.as_deref(), limit, offset)
}
