...
fn check_trailer_signature(file: &mut File, _file_size: u64) -> Result<Option<ArchiveFormat>, String> {
...
fn check_iso_signature(file: &mut File) -> Result<Option<ArchiveFormat>, String> {
...
fn check_aff4(file: &mut File) -> Result<bool, String> {
    // Reset to start
    file.seek(SeekFrom::Start(0))
