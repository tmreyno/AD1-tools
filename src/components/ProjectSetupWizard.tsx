import { Component, createSignal, createEffect, Show, For, on } from 'solid-js';
      ...
      <div class="wizard-overlay" onClick={(e) => e.target === e.currentTarget && props.onClose()}>
        <div class="wizard-modal">
          ...
          <div class="wizard-header">
            <h2>📁 Project Setup</h2>
            <button class="wizard-close" onClick={props.onClose} title="Close">×</button>
          </div>
              ...
              <div class="config-section">
                ...
                <div class="location-group">
                  ...
                  <div class="location-input">
                    ...
                    />
                    <button class="btn btn-default" onClick={browseEvidence}>Browse</button>
                  </div>
                    ...
                    <div class="suggested-paths">
                      ...
                      <For each={suggestedEvidence().slice(0, 5)}>
                        {(path) => (
                          <button
                            class="suggested-btn"
                            classList={{ selected: evidencePath() === path }}
                            onClick={async () => {
                ...
                <div class="location-group">
                  ...
                  <div class="location-input">
                    ...
                    />
                    <button class="btn btn-default" onClick={browseProcessed}>Browse</button>
                  </div>
                    ...
                    <div class="suggested-paths">
                      ...
                      <For each={suggestedProcessed().slice(0, 5)}>
                        {(path) => (
                          <button
                            class="suggested-btn"
                            classList={{ selected: processedDbPath() === path }}
                            onClick={async () => {
                  ...
                  <Show when={discoveredDatabases().length > 0}>
                    <div class="discovery-preview">
                      <For each={discoveredDatabases().slice(0, 5)}>
                        {(db) => (
                          <div class="discovered-item">
                            <span class="item-icon">{db.db_type === 'MagnetAxiom' ? '🧲' : db.db_type === 'CellebritePA' ? '📱' : '📁'}</span>
          ...
          <div class="wizard-footer">
            <Show when={step() === 1}>
              ...
              <button class="btn btn-primary" onClick={handleComplete} disabled={scanning()}>
