...
import { formatBytes, typeIcon, typeClass, debounce } from "../utils";
...
function normalizeContainerFields(info: ContainerInfo, storedHashes: StoredHash[]): InfoField[] {
  ...
  if (info.l01) {
    ...
    fields.push(
      ...
      { label: 'File Count', value: l01.file_count },
      { label: 'Total Size', value: l01.total_size, format: 'bytes' },
      { label: 'Case #', value: l01.case_info, type: 'highlight' },
      { label: 'Examiner', value: l01.examiner },
  ...
  if (info.archive) {
    ...
    fields.push(
      ...
      { label: 'Next Header', value: archive.next_header_offset ? `@ 0x${archive.next_header_offset.toString(16).toUpperCase()}` : undefined },
    );
